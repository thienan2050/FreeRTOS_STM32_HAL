...
/* Private variables ---------------------------------------------------------*/
xTaskHandle xTask2Handle, xTask1Handle;
/* USER CODE BEGIN PV */
...
int main(void)
{
  ...
  /* Create the first task at priority 2.  This time the task parameter is
	...
	is also set to NULL. */
  xTaskCreate( Task1,  "Task 1", configMINIMAL_STACK_SIZE, NULL, 2, &xTask1Handle );
  ...
  HAL_Delay(10000);
  printf("FreeRTOS is running now\n");
...
void Task1(void *pvParameters)
{
  ...
  for(;;)
  {
    printf("Task 1 is running, priority of Task 2 = ");
    printf("%d\n", (int)uxPriority);
...
void Task2(void *pvParameters)
{
  ...
  for(;;)
  {
    printf("Task 2 is running, priority of Task 1 = ");
    printf("%d\n", (int)uxPriority);
    HAL_Delay(2000);
  }
}
